...
import (
	...
	infra_repositories "github.com/caiogmrocha/golang-websockets-chat/server/internal/infra/repositories"
...
func NewAuthenticateUserController() *AuthenticateUserController {
  mongoUsersRepository := infra_repositories.MongoUsersRepository{}
